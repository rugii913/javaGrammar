...
public class JungsukExClassRunner implements Runnable {

    private final Class<?> targetClass;

    public JungsukExClassRunner(Class<?> targetClass) {
        this.targetClass = targetClass;
    }

    public static Runnable of(Class<?> targetClass) {
        return new JungsukExClassRunner(targetClass);
    }
    ...
    private void invokeWithExceptionHandling(Method method, Object object) {
        try {
            method.invoke(object); // TODO ***** 왜 정확한 타입 정보 없이 Object 타입일 뿐인데도 invoke할 수 있는지 찾아볼 것 *****
